      ...
      <div className="container">
        ...
        <div style={{ maxWidth: 820 }}>
          ...
          <p className="muted" style={{ lineHeight: 1.7 }}>
            Signed in as {session?.email || "guest"}. This page is ready to be connected to Supabase data and protected routes.
          </p>
        </div>
        ...
        {tab === "operations" && (
          <div className="three-col">
            {["Housekeeping assignments","Maintenance tickets","Arrival and departure workflow"].map((label) => (
              <Card key={label}><div className="summary-card"><h3>{label}</h3><p className="muted">Operational module prepared for the next build phase.</p></div></Card>
            ))}
          </div>
        )}
      </div>
